...
public class AboutJFrame extends JFrame {
    public AboutJFrame() {
        ...
        textLabel.setText("<html><body style='padding: 20px; font-size: 12px;'>" + // padding and font size increased
                "<div style='width:750px;'>" + // Reduce width to fit better within the background
                ...
                "3. Winning<br>" +
                "Basic Winning Hand: The basic winning hand requires forming 4 sets (either pungs or chows) + 1 pair of tiles.<br>" +
                ...
                "All Pungs: Consists of 4 pungs and 1 pair.<br>" +
                "Seven Pairs: The hand consists of 7 identical pairs, no pungs or chows required.<br>" +
                ...
                "Chow, Pung, Kong: Players can make a chow (only from the previous player), pung, or kong based on the last discarded tile. Chows are less common in Beijing Mahjong.<br>" +
        ...
        textLabel.setForeground(Color.white); // Set text color to black for visibility
